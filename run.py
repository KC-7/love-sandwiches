...
def update_surplus_worksheet(new_surplus_data):
    """ 
    Update surplus worksheet, add new row with returned surplus data.
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figue subtracted from the stock: 
...
print("Welocme to Love Sandwiches Data Automation")
main()